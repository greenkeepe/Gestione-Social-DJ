...
export function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className="group fixed bottom-24 right-4 z-40 flex items-center gap-2 rounded-full bg-[#25D366] py-2.5 pl-2.5 pr-2.5 text-ink shadow-md shadow-black/20 ring-1 ring-ink/10 transition-all duration-300 hover:pr-4 sm:bottom-8 sm:right-8 lg:bottom-8"
